...
namespace ERPWebAPI.BL.Concrete.OHS
{
    public class OHS_MmpiResultManager : IOHS_MmpiResultService<OHS_MmpiAnswer, SqlResult>
    {
        ...
        public OHS_MmpiResultManager(IOHS_MmpiResultDal oHS_MmpiResultDal)
        {
            _oHS_MmpiResultDal = oHS_MmpiResultDal;
        }
        ...
        {
            var result = _oHS_MmpiResultDal.ResultOperationsDal(module, target, point, parameters);
            if (!result.sqlReturn)
            {

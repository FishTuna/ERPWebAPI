...
namespace ERPWebAPI.Controllers.LGN
{
    ...
    {
        readonly ILGN_RoleMenuService<LGN_RoleMenu, SqlResult> _RoleMenuService;


        public RoleMenuController(ILGN_RoleMenuService<LGN_RoleMenu, SqlResult> RoleMenuService)
        {
        ...
        {
            var result = _RoleMenuService.GetAllDataMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
        ...
        {
            var result = _RoleMenuService.ResultOperationsMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
                return Ok(result.Data);
            }

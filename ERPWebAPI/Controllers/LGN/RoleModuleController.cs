...
namespace ERPWebAPI.Controllers.LGN
{
    ...
    {
        readonly ILGN_RoleModuleService<LGN_RoleModule, SqlResult> _RoleModuleService;


        public RoleModuleController(ILGN_RoleModuleService<LGN_RoleModule, SqlResult> RoleModuleService)
        {
        ...
        {
            var result = _RoleModuleService.GetAllDataMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
        ...
        {
            var result = _RoleModuleService.ResultOperationsMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
                return Ok(result.Data);
            }

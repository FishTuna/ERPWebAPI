...
namespace ERPWebAPI.Controllers.OHS
{
    ...
    {
        readonly IOHS_TrainingTypeService<OHS_TrainingType, SqlResult> _trainingTypeService;

        public TrainingTypeController(IOHS_TrainingTypeService<OHS_TrainingType, SqlResult> trainingTypeService)
        {
        ...
        {
            var result = _trainingTypeService.GetAllDataMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
        ...
        {
            var result = _trainingTypeService.ResultOperationsMngr(module, target, point, parameters);
            if (result.IsSuccess)
            {
                return Ok(result.Data);
            }
